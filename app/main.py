...
def format_linter_report(linter_report: dict) -> list:
    return [{"errors": value, "path": key, "status": "passed"} if value == []
            else {"errors": [{"line": error["line_number"], "column": error["column_number"], "message": error["text"],
                              "name": error["code"], "source": "flake8"} for error in value], "path": key,
                  "status": "failed"}
